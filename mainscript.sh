...
python run_ddpg.py --train_names knife --test_names knife --expID 7 --video_count 0 --n_cycles 40000 --chunk 10 --point_cloud --load_path 7 --pointnet_load_path 2 --no_save_buffer  --num_parallel_envs 6 --num_rollouts 6 --n_test_rollouts 6
